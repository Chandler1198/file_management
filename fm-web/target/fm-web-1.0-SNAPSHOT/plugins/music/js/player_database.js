...
var myPlaylist = new jPlayerPlaylist({
     ...
     [
		 { title: "Save Me ", artist: "Original mix", mp3:"/plugins/music/ISA - Shy.mp3", poster: "/plugins/music/images/se.jpg"},
		 { title: "默", artist: "那英", mp3:"/plugins/music/nayin -mo.mp3 ", poster: "/plugins/music/images/ny.jpg"},
         { title: "画", artist: "花粥", mp3:"/plugins/music/花粥 - 画.mp3", poster: "/plugins/music/images/m3.jpg"},
		 { title: "Fire", artist: "Said The Sky", mp3:"/plugins/music/Elektronomia - Fire.mp3", poster: "/plugins/music/images/m3.jpg"}
	 ],
...
$("#magic li").find("a.playIcon").click(function () {
	...
	$(".jp-video").animate({left:0},"slow",function(){
		slideOut($(this));		
	}).delay(0).animate({left:"-480px"},350,function(){
		slideIn($(this));	
	});
