...
<head>
    <meta charset="utf-8">
    <title>黑夜里迷失的404错误页面</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="/s/shirohtml/css/style.css">
...
<div class="container">
    <div class="left-section">
        <div class="inner-content">
            <h1 class="heading">无权限</h1>
            <p class="subheading">很抱歉，您无权限访问该页面</p>
            <p class="index-btn"><a href="/main/index">返回首页</a></p>
        </div>
    </div>
